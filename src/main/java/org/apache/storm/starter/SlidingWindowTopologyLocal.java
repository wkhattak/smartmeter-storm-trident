...
import org.apache.storm.starter.bolt.TumblingWindowAvgBolt;
 ...
 */
public class SlidingWindowTopologyLocal {

    private static final Logger LOG = LoggerFactory.getLogger(SlidingWindowTopologyLocal.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("tumblingavg", new TumblingWindowAvgBolt().withTumblingWindow(new BaseWindowedBolt.Duration(15,TimeUnit.SECONDS)), 1)
        .shuffleGrouping("slidingsum");
